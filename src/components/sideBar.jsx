            ...
            <ul>
              ...
              <li>
                <a href="estimates.html">
                  <i data-feather="file-text"></i> <span>Estimates</span>
                </a>
              </li>
              <li>
              ...
              <li className="submenu">
                ...
                <ul>
                  ...
                  <li>
                    <a href="expenses-report.html">Expenses Report</a>
                  </li>
                  <li>
                    <a href="profit-loss-report.html">Profit & Loss Report</a>
                  </li>
                  <li>
                    <a href="taxs-report.html">Taxs Report</a>
                  </li>
                </ul>
              </li>
              <li>
              ...
              <li>
                <a href="profile.html">
                  <i data-feather="user-plus"></i> <span>Profile</span>
                </a>
              </li>
              <li className="submenu">
                <a href="#">
              ...
              <li>
                <a href="maps-vector.html">
                  <i data-feather="map-pin"></i> <span>Vector Maps</span>
                </a>
              </li>
              <li className="menu-title">
